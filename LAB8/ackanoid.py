...
def setting():
    ...
    while pup:
        ...
        screen.fill('black')
        myfont = pygame.font.Font('Cop.ttf',40)
...
def pause():
    ...
    while paused:
        ...
        screen.fill('white')
        myfont = pygame.font.Font('Cop.ttf',40)
        text_surface1 = myfont.render('options[O]',True,'Black')
        text_surface2= myfont.render('exit[E]',True,'Black')
        text_surface3 = myfont.render('continue[C]',True,'Black')
        screen.blit(text_surface1,(400,300))
        screen.blit(text_surface2,(400,350))
        screen.blit(text_surface3,(400,400))
        pygame.display.update()
